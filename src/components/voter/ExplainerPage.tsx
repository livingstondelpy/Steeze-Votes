      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            Built specifically for Ghanaian event organizers, award schemes, and pageants. We make sure every vote is genuine, verified on mobile, and protected by safe payout checks.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-gray-200 p-6 rounded-3xl space-y-3 shadow-xs">
            ...
            <h3 className="text-base font-bold text-gray-900">
              2. 24-Hour Safe Payout Window
            </h3>
            <p className="text-xs text-gray-600 leading-relaxed">
              When a contest ends, the money stays safe for 24 hours. If any organizer or nominee flags an issue, our team checks our records before releasing the money to the organizer.
            </p>
          </div>
        ...
        <div className="bg-white border border-gray-200 p-6 sm:p-8 rounded-3xl space-y-4 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-bold text-gray-900">
              Clear Pricing for Paid Votes
            </h3>
          </div>

          <p className="text-xs text-gray-600 leading-relaxed">
            We make buying vote packages simple and convenient across all major mobile networks in Ghana:
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 space-y-1">
              <span className="text-[11px] font-semibold text-gray-500 uppercase">1 Free Vote</span>
              <p className="text-xl font-bold text-emerald-600">GHS 0.00</p>
              <p className="text-[11px] text-gray-500">Every Ghana phone number gets 1 free verified vote per contest.</p>
            </div>

            <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 space-y-1">
              <span className="text-[11px] font-semibold text-gray-500 uppercase">Paid Bundles</span>
              <p className="text-xl font-bold text-amber-600">From GHS 1.00</p>
              <p className="text-[11px] text-gray-500">Buy extra vote packages using MTN, Telecel, or AT Mobile Money.</p>
            </div>

            <div className="p-4 rounded-2xl bg-gray-50 border border-gray-200 space-y-1">
              <span className="text-[11px] font-semibold text-gray-500 uppercase">Instant Receipts</span>
              <p className="text-xl font-bold text-gray-800">100% Verifiable</p>
              <p className="text-[11px] text-gray-500">Instant digital receipts and WhatsApp share codes for every payment.</p>
            </div>
          </div>
        </div>
