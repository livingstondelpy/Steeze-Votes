    ...
    <div className="bg-gray-50 min-h-screen text-gray-900 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white border border-gray-200 text-xs font-semibold text-gray-700 hover:bg-gray-50 hover:text-gray-900 shadow-xs transition-colors"
            >
              <Share2 className="w-3.5 h-3.5 text-amber-600" /> Share Contest
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-xs">
          ...
          {!lowDataMode && (
            <div className="relative aspect-[21/9] sm:aspect-[24/8] w-full overflow-hidden bg-gray-100">
              <img
              ...
              <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 text-white max-w-2xl">
                <span className="inline-block px-2.5 py-1 rounded-md text-[11px] font-bold bg-amber-500 text-white mb-2 shadow-xs">
                  {contest.category}
                </span>
        ...
        <div className="mt-10 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Select a nominee to cast 1 free vote or buy Mobile Money vote packages.
            </p>
          </div>
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              placeholder="Search nominee or code..."
        ...
        {filteredNominees.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-2xl border border-gray-200 p-8 space-y-3">
            <p className="text-sm font-semibold text-gray-700">No nominee found</p>
            <p className="text-xs text-gray-500">Try searching with a different name or nominee code.</p>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredNominees.map((nominee, idx) => (
              <NomineeCard
                ...
                onVoteFree={(nom) => setSelectedNomineeForFree(nom)}
                onVotePaid={(nom) => setSelectedNomineeForPaid(nom)}
              />
            ))}
          </div>
        )}
        ...
        <div className="mt-12 p-4 rounded-2xl bg-white border border-gray-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600">
          <div className="flex items-center gap-2.5">
            ...
            <span>
              All votes on SteezeVotes are secured by Ghana phone number verification and our 24-hour dispute escrow hold.
            </span>
          </div>
